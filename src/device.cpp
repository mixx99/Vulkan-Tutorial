...
void Device::setWindow(Window window_2) { window.setWindow(window_2); }
...
std::vector<VkImage> &Device::getSwapChainImages() { return swapChainImages; }

VkFormat Device::getSwapChainImageFormat() { return swapChainImageFormat; }
